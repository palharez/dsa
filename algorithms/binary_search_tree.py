        ...
        if self.empty():
            ...
            while True:
                if curr_node != None:
                    ...
                    # verifica se vai pra esquerda ou pra direita
                    ...
                    # se curr node é None, então enctrou onde inserir
        ...
        while curr_node != None:
            ...
            if label == curr_node.getLabel():
               # caso 1: o nó a ser removido não possui filhos(nó folha)
                ...
                # caso 2: o no a ser removido possui somento um filho
                    ...
                    if dad_node == None:
                         # verifica se o filho de curr_node é filho a equerda
                        ...
                        if curr_node.getLeft() != None:
                            # verifica se o curr_node é filho a esquerda
                ...
                # pega-se o menor elemento da subárvore a direita
                    ...
                    # verifica se o nó a ser removido é a raiz
                    if dad_node == None:
                        # Caso espcial: o nó que vai ser raiz é o filho da raiz
                        if self.root.getRight().getLabel() == smaller_node.getLabel():
                            smaller_node.setLeft(self.root.getLeft())
                        else:
                            '''
                                verifica s o smaller_node é filho à esqierda ou à direita
                        ...
                        '''
                            verifica se o curr_node é filho à esquerda ou à direita
                        ...
                        '''
                            ...
                            para setar None o smaller_node
                        '''
                        if dad_smaller_node.getLeft() and \
                                dad_smaller_node.getLeft().getLabel() == smaller_node.getLabel():
                            dad_smaller_node.setLeft(None)
                        ...
                        # seta os ilhos à direita e esquerda de smaller_node
                        smaller_node.setLeft(curr_node.getLeft())
                        smaller_node.setRight(curr_node.getRight())
