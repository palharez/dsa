      ...
      if self.empty():
        ...
        if index == 0:
          ...
          while curr_node != None:
            if curr_index == index:
              # seta o curr_node coo o próximo do nó
              node.setNext(curr_node)
              # set o node como o próximo do prev_node
  ...
  def pop(self, index):
    if not self.empty () and index >= 0 and index < self.len_list:
      ...
      if self.first.getNext() == None:
        ...
        # remove do inicio, mas possui mais de 1 elmento
        self.first = self.first.getNext()
        flag_remove = True
      else:
        '''
          Se chegou aqui é porque a lista possui mais
          de 1 elemento e a remoção não é no inicio
        '''
        prev_node = self.first
        curr_node = self.first.getNext()
        curr_index = 1
        ...
        while curr_node !=  None:
          ...
          if index == curr_index:
            # o próxim do anterio aponta para o próximo do nó corrente
